...
Backup Time: 2020-03-10 09:16:47
*/
...
INSERT INTO "public"."order_details" ("id","product_id","order_id","quantity","price","amount","created_at","updated_at") VALUES (11, 2, 11, 1, 20000, 20000, '2020-03-09 17:16:48', '2020-03-09 17:16:48'),(12, 3, 11, 1, 25000, 25000, '2020-03-09 17:16:48', '2020-03-09 17:16:48'),(13, 2, 12, 1, 20000, 20000, '2020-03-09 17:53:28', '2020-03-09 17:53:28'),(14, 3, 13, 1, 25000, 25000, '2020-03-09 18:01:53', '2020-03-09 18:01:53'),(15, 2, 13, 1, 20000, 20000, '2020-03-09 18:01:53', '2020-03-09 18:01:53'),(16, 1, 13, 1, 10000, 10000, '2020-03-09 18:01:53', '2020-03-09 18:01:53'),(17, 3, 14, 1, 25000, 25000, '2020-03-10 02:14:19', '2020-03-10 02:14:19'),(18, 2, 14, 1, 20000, 20000, '2020-03-10 02:14:19', '2020-03-10 02:14:19'),(19, 1, 14, 1, 10000, 10000, '2020-03-10 02:14:19', '2020-03-10 02:14:19');
COMMIT;
BEGIN;
LOCK TABLE "public"."orders" IN SHARE MODE;
DELETE FROM "public"."orders";
INSERT INTO "public"."orders" ("id","code","user_id","status","created_at","updated_at","address","grand_total") VALUES (11, 'ODR-1583774208', 1, 't', '2020-03-09 17:16:48', '2020-03-09 17:51:05', '{"name":"Nazmudin Alkhamil","email":"alkhamilnaz@gmail.com","telepon":null,"address":"Kp leuwilisung Rt\/01 rw\/01\r\nJl raya cibeber raya"}', 45000),(12, 'ODR-1583776408', 1, 't', '2020-03-09 17:53:28', '2020-03-09 18:00:01', '{"name":"Nazmudin Alkhamil","email":"alkhamilnaz@gmail.com","telepon":null,"address":"Kp leuwilisung Rt\/01 rw\/01\r\nJl raya cibeber raya"}', 20000),(13, 'ODR-1583776913', 1, 't', '2020-03-09 18:01:53', '2020-03-09 18:02:24', '{"name":"Nazmudin Alkhamil","email":"alkhamilnaz@gmail.com","telepon":null,"address":"Kp leuwilisung Rt\/01 rw\/01\r\nJl raya cibeber raya"}', 55000),(14, 'ODR-1583806459', 1, 't', '2020-03-10 02:14:19', '2020-03-10 02:15:38', '{"name":"Nazmudin Alkhamil","email":"alkhamilnaz@gmail.com","telepon":null,"address":"Kp leuwilisung Rt\/01 rw\/01\r\nJl raya cibeber raya"}', 55000);
COMMIT;
BEGIN;
LOCK TABLE "public"."products" IN SHARE MODE;
DELETE FROM "public"."products";
INSERT INTO "public"."products" ("id","name","price","quantity","description","created_at","updated_at") VALUES (3, 'ProductC', 25000, 6, 'Product C Adalah Product C', '2020-03-09 21:55:26', '2020-03-10 02:14:19'),(2, 'ProductB', 20000, 4, 'Product B Adalah Product B', '2020-03-09 21:55:19', '2020-03-10 02:14:19'),(1, 'ProductA', 10000, 5, 'Product A Adalah Product A', '2020-03-09 21:55:13', '2020-03-10 02:14:19');
COMMIT;
BEGIN;
...
SELECT setval('"order_details_id_seq"', 20, true);
