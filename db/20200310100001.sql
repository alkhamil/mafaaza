...
Backup Time: 2020-03-10 10:00:03
*/
...
INSERT INTO "public"."order_details" ("id","product_id","order_id","quantity","price","amount","created_at","updated_at") VALUES (20, 1, 15, 1, 10000, 10000, '2020-03-10 02:40:39', '2020-03-10 02:40:39'),(21, 2, 16, 1, 20000, 20000, '2020-03-10 02:55:00', '2020-03-10 02:55:00'),(22, 1, 16, 1, 10000, 10000, '2020-03-10 02:55:00', '2020-03-10 02:55:00'),(23, 3, 17, 1, 25000, 25000, '2020-03-10 02:58:32', '2020-03-10 02:58:32');
COMMIT;
BEGIN;
LOCK TABLE "public"."orders" IN SHARE MODE;
DELETE FROM "public"."orders";
INSERT INTO "public"."orders" ("id","code","user_id","status","created_at","updated_at","address","grand_total") VALUES (15, 'ODR-1583808039', 3, 't', '2020-03-10 02:40:39', '2020-03-10 02:52:05', '{"name":"customer","email":"customer@customer.com","telepon":null,"address":"jalan raya jambu manis no 34 rt 2\/rw7 bogor"}', 10000),(16, 'ODR-1583808900', 3, 't', '2020-03-10 02:55:00', '2020-03-10 02:58:47', '{"name":"customer","email":"customer@customer.com","telepon":null,"address":"Kp cibeber jalan"}', 30000),(17, 'ODR-1583809112', 3, 't', '2020-03-10 02:58:32', '2020-03-10 02:58:51', '{"name":"customer","email":"customer@customer.com","telepon":null,"address":"ihh"}', 25000);
COMMIT;
BEGIN;
LOCK TABLE "public"."products" IN SHARE MODE;
DELETE FROM "public"."products";
INSERT INTO "public"."products" ("id","name","price","quantity","description","created_at","updated_at") VALUES (2, 'ProductB', 20000, 3, 'Product B Adalah Product B', '2020-03-09 21:55:19', '2020-03-10 02:55:00'),(1, 'ProductA', 10000, 3, 'Product A Adalah Product A', '2020-03-09 21:55:13', '2020-03-10 02:55:00'),(3, 'ProductC', 25000, 5, 'Product C Adalah Product C', '2020-03-09 21:55:26', '2020-03-10 02:58:32');
COMMIT;
BEGIN;
...
SELECT setval('"order_details_id_seq"', 24, true);
